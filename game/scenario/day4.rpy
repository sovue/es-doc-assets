...
label day4_main2:
    ...
    if d1_keys and not d2_gave_keys:
        ...
        show sl shy pioneer at center with dspr
    sl "Да нет, ничего…"
    th "Странно.{w} Всегда такая открытая Славя о чём-то умалчивает?"
...
label day4_dv:
    ...
    "Она вела себя даже чересчур самоуверенно.{w} Совсем не в пример мне – каждый шорох кустов рядом и крик совы над головой заставляли меня ёжиться и боязливо оглядываться по сторонам."
