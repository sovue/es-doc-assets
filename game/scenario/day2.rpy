...
label day2_main1:
    ...
    "Да и поза у него какая-то странная – как будто смотрит на происходящее с недоверием, может быть, с пренебрежением или даже надменностью."
...
label day2_main2:
    ...
    me "В карты?"
    el "Да! Я игру новую придумал. Интере-е-есную!"
    me "И какую же?"
...
label day2_cards:
    ...
    "Кажется, одной этой девочки было бы достаточно для варп-прыжка к Альфе Центавра."
