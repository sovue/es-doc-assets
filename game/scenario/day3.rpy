...
label day3_main2:
    ...
    if day3_breakfast_with_un == 1:
        "Странно, на завтраке она казалась куда смелее."
    show cs normal at center with dspr
...
label day3_cleaning_us:
    ...
    show us dontlike sport at center with dspr
    us "Как видишь!"
    "Ульянка выглядела расстроенной, весь её детский задор куда-то исчез."
...
label day3_evening_dv:
    ...
    me "А-а-а… Хорошо, внимательно слушаю."
...
label day3_fail:
    ...
    if _preferences.language == "spanish":
        ...
        $ urhere = "Você está aqui por um motivo"
    else:
