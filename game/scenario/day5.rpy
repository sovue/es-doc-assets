...
label day5_main2:
    ...
    stop ambience fadeout 2
    "После спортивной гребли они казались мешками с цементом, хотя вряд ли весили больше пары килограммов каждая."
    window hide
    $ persistent.sprite_time = "day"
    scene bg ext_houses_day
    with dissolve
...
label day5_clubs_2:
    ...
    "Не знаю, сколько он весил, но казалось, что точно не менее двадцати килограммов."
...
label day5_library_2:
    ...
    mz "Чего тебе?"
    me "Э-э-э…{w} Ты не подумай ничего, мне бы…"
...
label day5_main3:
    ...
    "Конечно, я бы с куда большим удовольствием сейчас просто лёг, закрыл глаза и заснул, но нельзя подводить Ольгу Дмитриевну."
