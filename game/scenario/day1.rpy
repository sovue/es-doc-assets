...
label day1:
    ...
    with dissolve
    window show
    "Судя по всему, этот лагерь (если это, конечно, лагерь) – единственное место, где могли быть люди, поэтому я решил пойти туда и уже почти дошёл до ворот, как..."
    ...
    "То ли взял самоотвод инстинкт самосохранения, то ли вся эта беготня по лагерю и местные пионеры настолько убаюкали меня своей беззаботной нормальностью, что я иногда просто забывал о том, что со мной произошло буквально пару часов назад."
    ...
    "Глупо спрашивать у человека, попавшего в одночасье в другую реальность, понравились ли ему меню в столовой, вожатая и отведённое койко-место."
    ...
    me "Тогда и не стоит обращать внимания на других."
