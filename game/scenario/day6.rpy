...
label day6_sl:
    ...
    "Хоть звучало и романтично, но мне показалось, что сейчас Славя сказала глупость."
...
label day6_dv:
    ...
    me "Э-э-э?{w} Можно поинтересоваться, какие?"
    ...
    "К тому же меня не отпускали мысли о вчерашнем разговоре с Леной на острове."
