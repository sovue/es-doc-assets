...
init:
    if _preferences.language == "english":
        ...
        image widget map = get_image("maps/map_pg.jpg")
    elif _preferences.language == "turkish":
        image widget map = get_image("maps/map_tr.jpg")
    else:
...
init -997 python:
    ...
    if _preferences.language == "english":
        ...
        store.map_pics = {
            "bgpic": get_image("maps/map_pg.jpg"),
            "available": get_image("maps/map_pg_available.jpg"),
            "selected": get_image("maps/map_pg_selected.jpg")
        }
    elif _preferences.language == "turkish":
        store.map_pics = {
            "bgpic": get_image("maps/map_tr.jpg"),
            "available": get_image("maps/map_tr_available.jpg"),
            "selected": get_image("maps/map_tr_selected.jpg")
        }
    else:
        store.map_pics = {
